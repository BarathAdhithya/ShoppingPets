<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>   <!-- spring form -->
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> <!-- Core tag -->
<!DOCTYPE html>
<html lang="en-US">
<head><title>Admin</title>
</head>
<body>
  <c:url var="addAction" value="addItem" ></c:url> <!-- Jstl tag avaible in core tag lib,  -->

<form:form action="${addAction}" modelAttribute="product" id="btn-add"> <!--dummy object,  --> 
   <h3>
	  ...
	  <table>   
			<tr>
			 <td> ID </td>
    	      ...
    	      <c:forEach var="obj" items="${allData}"> <!-- pre defined standard library in core -->
		      <tr>
